...
uv run -m app.main "Il pleut et les nuages sont absents" -l eng_Latn -s fra_Latn
>>> "It's raining and the clouds are gone"

- Français vers Allemand
uv run -m app.main "Il pleut et les nuages sont absents" -l deu_Latn -s fra_Latn
>>> Es regnet und die Wolken sind weg

- Français vers Zoulou
uv run -m app.main "Il pleut et les nuages sont absents" -l zul_Latn -s fra_Latn
>>> Imvula Iyahla futhi Amafu Aphuthelwa
